...
CONF_ENABLE_AUTOMATION_CONTACTS = "enable_automation_contacts"
CONF_AUTOMATION_COOKIES = "automation_cookies"
CONF_AUTOMATION_INSTALLATION = "automation_installation"
